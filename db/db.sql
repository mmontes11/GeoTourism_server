...
CREATE TABLE IF NOT EXISTS "Region"(
	...
	CONSTRAINT Region_Country_FK FOREIGN KEY(countryId) REFERENCES "Country"(id) ON DELETE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS "City"(
	...
	CONSTRAINT City_Region_FK FOREIGN KEY(regionId) REFERENCES "Region"(id) ON DELETE NO ACTION,
...
CREATE TABLE IF NOT EXISTS "UserRoute"(
	id SERIAL,
	userId INTEGER,
	routeId INTEGER,
...
CREATE TABLE IF NOT EXISTS "UserTIP"(
	id SERIAL,
	userId INTEGER,
	TIPId INTEGER,
...
CREATE TABLE IF NOT EXISTS "RouteTIP"(
	id SERIAL,
	"order" INTEGER,
	routeId INTEGER,
	TIPId INTEGER,
