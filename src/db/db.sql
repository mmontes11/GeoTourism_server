...
DROP TABLE IF EXISTS UserAccountTIP CASCADE;
...
CREATE TABLE UserAccountTIP(
  id SERIAL,
  userId INTEGER,
  TIPId INTEGER,
  CONSTRAINT UserAccountTIP_PK PRIMARY KEY(id),
  CONSTRAINT UserAccountTIP_UserAccount_FK FOREIGN KEY(userId) REFERENCES UserAccount(id) ON DELETE CASCADE,
  CONSTRAINT UserAccountTIP_TIP_FK FOREIGN KEY(TIPId) REFERENCES TIP(id) ON DELETE CASCADE
);
