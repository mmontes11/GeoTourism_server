...
DROP TABLE IF EXISTS OSMValue CASCADE;
...
CREATE TABLE OSMValue(
  id SERIAL,
  OSMKeyId INTEGER,
  value VARCHAR(50),
  CONSTRAINT OSMValue_PK PRIMARY KEY (id),
  CONSTRAINT OSMValue_OSMKey_FK FOREIGN KEY (OSMKeyId) REFERENCES OSMKey(id)
);

CREATE TABLE OSMType(
  id SERIAL,
  OSMValueId INTEGER NOT NULL,
  TIPTypeId INTEGER NOT NULL,
  CONSTRAINT OSMType_PK PRIMARY KEY (id),
  CONSTRAINT OSMType_OSMValue_FK FOREIGN KEY (OSMValueId) REFERENCES OSMValue(id),
  CONSTRAINT OSMType_TIPType_FK FOREIGN KEY (TIPTypeId) REFERENCES TIPtype(id),
  CONSTRAINT OSMType_Unique UNIQUE(id,OSMValueId,TIPTypeId)
);
...
INSERT INTO OSMKey VALUES(1,'tourism');
INSERT INTO OSMKey VALUES(2,'historic');
INSERT INTO OSMKey VALUES(3,'amenity');

INSERT INTO OSMValue VALUES(1,1,'hostel');
INSERT INTO OSMValue VALUES(2,1,'hotel');
INSERT INTO OSMValue VALUES(3,1,'viewpoint');
INSERT INTO OSMValue VALUES(4,2,'monument');
INSERT INTO OSMValue VALUES(5,3,'restaurant');

INSERT INTO OSMType(OSMValueId, TIPTypeId) VALUES (1,3);
INSERT INTO OSMType(OSMValueId, TIPTypeId) VALUES (2,3);
INSERT INTO OSMType(OSMValueId, TIPTypeId) VALUES (3,2);
INSERT INTO OSMType(OSMValueId, TIPTypeId) VALUES (4,1);
INSERT INTO OSMType(OSMValueId, TIPTypeId) VALUES (5,4);
