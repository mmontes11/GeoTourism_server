...
public class RouteServiceFindTest {
    ...
    public void createData() {
        try {
            ...
            tipDetailsDto = tipService.create(HOTEL_DISCRIMINATOR, name, description, VALID_TIP_PHOTO_URL, VALID_TIP_INFO_URL, geom, null);
            hotelRiazorID = tipDetailsDto.getId();

            name = "Restaurante Alma Negra";
            description = "Yummy";
            geom = GeometryUtils.geometryFromWKT(POINT_ALMA_NEGRA);
            tipDetailsDto = tipService.create(RESTAURANT_DISCRIMINATOR, name, description, VALID_TIP_PHOTO_URL, VALID_TIP_INFO_URL, geom, null);
